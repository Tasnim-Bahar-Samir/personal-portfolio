...
const Footer = () => {
  return (
    <div className=' border-t'>
      <footer className="footer max-w-7xl mx-auto p-10 bg-slate-900 text-neutral-content relative">
<div>
  ...
  <p>Desiged and build by <span className='text-lg font-semibold'>Sa<span className=" text-orange-600">Mir</span></span><br/>© All Rights Reserved.</p>
</div> 
<div>
